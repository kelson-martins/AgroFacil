 ...
 * @author Kelson
 */
public class FrmPesquisaMunicipio extends javax.swing.JDialog {

    /**
     * Creates new form FrmSearchMunicipio
     */
    private final MunicipioDAO dao = new MunicipioDAO();
    private List<Municipio> municipio = new LinkedList<Municipio>();
    private JComboBox combo;
    
    public FrmPesquisaMunicipio(JComboBox combo) {
        //super(main, modal);
        this.combo = combo;
    ...
    private void btSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelecionarActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            combo.setSelectedItem(municipio.get(jTable1.getSelectedRow()));
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        try {
            municipio = dao.getMunicipioByName(tfPesquisa.getText());
