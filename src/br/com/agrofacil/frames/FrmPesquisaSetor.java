 ...
 * @author Kelson
 */
public class FrmPesquisaSetor extends javax.swing.JDialog {
    ...
    public FrmPesquisaSetor(JComboBox combo) {
        //super(main, modal);
        this.combo = combo;
    ...
    private void btSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelecionarActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            List<Setor> lista = new Vector<Setor>();
            lista.add(setor.get(jTable1.getSelectedRow()));
            DefaultComboBoxModel dcbmCentro = new DefaultComboBoxModel(new Vector<Setor>(lista));    
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        try {
            setor = dao.getSetorByName(tfPesquisa.getText());
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
        if (setor.size() > 0) {
            for (int i = 0; i < setor.size(); i++) {
                values.add(new String[] {String.valueOf(setor.get(i).getId()),setor.get(i).getDescricao(),setor.get(i).getFazenda().getDescricao()});
            }               
        }                        
