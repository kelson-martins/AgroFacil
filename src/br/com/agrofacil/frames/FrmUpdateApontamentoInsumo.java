 ...
 * @author Kelson
 */
public class FrmUpdateApontamentoInsumo extends javax.swing.JInternalFrame {
    ...
    private final ApontamentoInsumo apontamentoInEdit;
    
    public FrmUpdateApontamentoInsumo(javax.swing.JDesktopPane parent, boolean modal,ApontamentoInsumoDAO dao, FrmApontamentoInsumo control, ApontamentoInsumo apontamentoInEdit) throws SQLException {             
        this.dao = dao;
        this.control = control;
        this.apontamentoInEdit = apontamentoInEdit;
        this.setTitle("Atualizar Apontamento de Insumo");
        initComponents();
        initMyComponents();
        initTableItens();
    }
    ...
    private void btOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOkActionPerformed
        ...
        try {
            ...
            dao.updateApontamentoInsumo(apont);
    ...
    private void btAddItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddItemActionPerformed
        ...
        try {
            dialog = new FrmAddApontamentoInsumoItem(new java.awt.Frame(), true,itens,this);
...
private void initMyComponents() throws SQLException {  
   ...
   txtHoraInicial.setText(apontamentoInEdit.getHoraIni());
   txtHoraFinal.setText(apontamentoInEdit.getHoraFim());

   List<CentroCusto> centroLista = new LinkedList<>();
   CentroCusto centro = new CentroCustoDAO().getCentroCusto(apontamentoInEdit.getCentro().getId());
   ...
   List<FrenteTransporte> frenteLista = new LinkedList<>();
   FrenteTransporte frente = new FrenteTransporteDAO().getFrenteTransporte(apontamentoInEdit.getFrente().getId());
   frenteLista.add(frente);
   //vectorAux.clear();
   //vectorAux.add(frente);
   DefaultComboBoxModel dcbmFrente = new DefaultComboBoxModel(new Vector<FrenteTransporte>(frenteLista));
   ...
   //vectorAux.clear();
   //vectorAux.add(talhao);
   DefaultComboBoxModel dcbmTalhao = new DefaultComboBoxModel(new Vector<Talhao>(talhaoLista));
   cbTalhao.setModel(dcbmTalhao);
   
   Equipamento equipamento = new EquipamentoDAO().getEquipamento(apontamentoInEdit.getEquipamento().getId());
   vectorAux.clear();
   vectorAux.add(equipamento);
   DefaultComboBoxModel dcbmEquip = new DefaultComboBoxModel(vectorAux);
   cbEquipamento.setModel(dcbmEquip);
   
   cbTipoAplicacao.setModel(new DefaultComboBoxModel(TipoPlantioColheita.values()));
   cbTipoAplicacao.setSelectedItem(apontamentoInEdit.getTipoSistema());
   
   SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");     
   txtDataOperacao.setText(df.format(apontamentoInEdit.getDataOperacao()));
   
   txtQtdAplicada.setText(String.valueOf(apontamentoInEdit.getQtdAplicada()).replace('.', ','));
   txtQtdAreaAplicada.setText(String.valueOf(apontamentoInEdit.getQtdAreaAplicada()).replace('.', ','));
   
}    

private void initTableItens() throws SQLException {
       ...
       List<String[]> values = new ArrayList<String[]>();
        ...
        itens = dao.getApontamentoInsumoItem(apontamentoInEdit);
        if (itens.size() > 0) {
            for (int i = 0; i < itens.size(); i++) {
                values.add(new String[] {
                itens.get(i).getInsumo().getDescricao(),
       ...
       //tblItens.setAutoResizeMode(tblItens.AUTO_RESIZE_OFF);
