 ...
 * @author Kelson
 */
public class FrmUpdateOperacao extends javax.swing.JInternalFrame {
    ...
    public FrmUpdateOperacao(javax.swing.JDesktopPane parent, boolean modal,OperacaoDAO dao, Operacao operacao, FrmOperacao control) throws SQLException {             
        this.dao = dao;
        this.operacao = operacao;
        this.control = control;
        this.setTitle("Atualizar Operacao");
        initComponents();
        initMyComponents();
    ...
    private void initComponents() {
        ...
        lblDescricao1.setText("Unidade de Medida");
    ...
    private void btOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOkActionPerformed
       ...
       int result = JOptionPane.showConfirmDialog(this, "Você Tem Certeza ??","Atualizar Operacao",JOptionPane.OK_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE);
       ...
       if(result != 0) {
        ...
        try {
            ...
            operacao.setId(operacao.getId());
            operacao.setDescricao(txtDescricao.getText());
            operacao.setUnidadeMedida((UnidadeMedida)cbunidadeMedida.getSelectedItem());

            dao.updateOperacao(operacao);
            control.loadInitialData();
        } catch(Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Erro ao Atualizar Operacao "+e,"Error",JOptionPane.ERROR_MESSAGE);
        }
...
private void initMyComponents() throws SQLException {  
   ...
   cbunidadeMedida.setSelectedItem(operacao.getUnidadeMedida());
