 ...
 * @author Kelson
 */
public class FrmPesquisaFazenda extends javax.swing.JDialog {

    /**
     * Creates new form FrmSearchMunicipio
     */
    private final FazendaDAO dao = new FazendaDAO();
    private List<Fazenda> fazenda = new LinkedList<Fazenda>();
    private JComboBox combo;
    
    public FrmPesquisaFazenda(JComboBox combo) {
        //super(main, modal);
        this.combo = combo;
    ...
    private void btSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelecionarActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            List<Fazenda> lista = new Vector<Fazenda>();
            lista.add(fazenda.get(jTable1.getSelectedRow()));
            DefaultComboBoxModel dcbmCentro = new DefaultComboBoxModel(new Vector<Fazenda>(lista));    
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        try {
            fazenda = dao.getFazendaByName(tfPesquisa.getText());
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
        if (fazenda.size() > 0) {
            for (int i = 0; i < fazenda.size(); i++) {
                values.add(new String[] {String.valueOf(fazenda.get(i).getId()),fazenda.get(i).getDescricao(),fazenda.get(i).getMunicipio().getNome()});
            }               
        }                        
