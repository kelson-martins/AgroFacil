 ...
 * @author Kelson
 */
public class FrmPesquisaInsumo extends javax.swing.JDialog {

    /**
     * Creates new form FrmSearchMunicipio
     */
    private final InsumoDAO dao = new InsumoDAO();
    private List<Insumo> insumo = new LinkedList<Insumo>();
    private JComboBox combo;
    
    public FrmPesquisaInsumo(JComboBox combo) {
        //super(main, modal);
        this.combo = combo;
    ...
    private void btSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelecionarActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            List<Insumo> lista = new Vector<Insumo>();
            lista.add(insumo.get(jTable1.getSelectedRow()));
            DefaultComboBoxModel dcb = new DefaultComboBoxModel(new Vector<Insumo>(lista));    
            combo.setModel(dcb);
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        try {
            insumo = dao.getInsumoByName(tfPesquisa.getText());
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
        jTable1.setModel(new MyTableModel(Insumo.class, insumo, jTable1));        
