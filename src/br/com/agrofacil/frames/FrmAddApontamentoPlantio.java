 ...
 * @author Kelson
 */
public class FrmAddApontamentoPlantio extends javax.swing.JInternalFrame {
    ...
    public FrmAddApontamentoPlantio(javax.swing.JDesktopPane parent, boolean modal,ApontamentoPlantioDAO dao, FrmApontamentoPlantio control) throws SQLException {             
        this.dao = dao;
        this.control = control;
        this.setTitle("Adicionar Apontamento de Plantio");
        initComponents();
        initMyComponents();
        refreshItens();
    }
    ...
    private void btnProducrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProducrarActionPerformed
        try {
            ...
            Logger.getLogger(FrmAddApontamentoPlantio.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOkActionPerformed
        ...
        try {
            ...
            dao.addApontamentoPlantio(apont,true);
