...
public class FrmFuncionario extends javax.swing.JInternalFrame {
    ...
    public FrmFuncionario(FrmPrincipal main) throws SQLException {
        this.main = main;
        this.setTitle("Manutenção - Funcionarios");
    ...
    private void btAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAdicionarActionPerformed
        ...
        try {
            ...
            FrmAddFuncionario dialog = new FrmAddFuncionario(new javax.swing.JDesktopPane(), true,dao,this);    
...
/*
    ...
    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        // TODO add your handling code here:
        if(jTable1.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this, "Escolha Funcionario para Remover !!");
            return;
        }

        int result = JOptionPane.showConfirmDialog(this, "Você tem Certeza ??","Remover Funcionario",JOptionPane.OK_CANCEL_OPTION);
        ...
        try {
            try {
                dao.deleteFuncionario(
                        funcionarios.get(jTable1.getSelectedRow()).getId());
            } catch (SQLException ex) {
                ex.printStackTrace();
                JOptionPane.showMessageDialog(this, "Erro ao Remover Funcionario","Remover Funcionario",JOptionPane.ERROR_MESSAGE);
            }
            loadInitialData();
        } catch (SQLException ex) {
            Logger.getLogger(FrmFuncionario.class.getName()).log(Level.SEVERE, null, ex);
   ...
   public void loadInitialData() throws SQLException {
    try {
            funcionarios = dao.getAllFuncionario();
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
jTable1.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
                        ...
                        tca.adjustColumns();    
        jTable1.setModel(new MyTableModel(Funcionario.class, funcionarios, jTable1));
    }
