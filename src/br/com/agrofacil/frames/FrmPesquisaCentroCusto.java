 ...
 * @author Kelson
 */
public class FrmPesquisaCentroCusto extends javax.swing.JDialog {

    /**
     * Creates new form FrmSearchMunicipio
     */
    private final CentroCustoDAO dao = new CentroCustoDAO();
    private List<CentroCusto> centro = new LinkedList<CentroCusto>();
    private JComboBox combo;
    
    public FrmPesquisaCentroCusto(JComboBox combo) throws SQLException {
        //super(main, modal);
        this.combo = combo;
    ...
    private void btSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelecionarActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            List<CentroCusto> lista = new Vector<CentroCusto>();
            lista.add(centro.get(jTable1.getSelectedRow()));
            DefaultComboBoxModel dcbmCentro = new DefaultComboBoxModel(new Vector<CentroCusto>(lista));    
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        try {
            centro = dao.getCentroByName(tfPesquisa.getText());
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
        if (centro.size() > 0) {
            for (int i = 0; i < centro.size(); i++) {
                values.add(new String[] {centro.get(i).getIdInterfaceErp(),centro.get(i).getDescricao(),centro.get(i).getTipoCentroCusto().toString()});
            }               
        }                        
