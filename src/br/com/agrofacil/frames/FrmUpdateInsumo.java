 ...
 * @author Kelson
 */
public class FrmUpdateInsumo extends javax.swing.JInternalFrame {
    ...
    public FrmUpdateInsumo(javax.swing.JDesktopPane parent, boolean modal,InsumoDAO dao, Insumo insumo, FrmInsumo control) throws SQLException {             
        this.dao = dao;
        this.control = control;
        this.insumo = insumo;
        this.setTitle("Atualizar Insumo");
        initComponents();
        initMyComponents();
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(tfIntervalo, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOkActionPerformed
        try {
            ...
            dao.updateInsumo(insumo);

            int result = JOptionPane.showConfirmDialog(this, "Você Tem Certeza ??","Atualizar Insumo",JOptionPane.OK_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE);
            if(result != 0) {
                return;
            }
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Erro ao Atualizar Insumo "+e,"Error",JOptionPane.ERROR_MESSAGE);
        }
...
private void initMyComponents() throws SQLException {  
   ...
   cbUnidadeMedida.setSelectedItem(insumo.getUnidadeMedida());
   
   if (insumo.isEstocavel() == true) {
       cbEstocavel.setSelectedIndex(0);
   } else {
       cbEstocavel.setSelectedIndex(1);
   }
   
   tfIntervalo.setText(String.valueOf(insumo.getIntervaloSeguranca()));
   taObs.setText(insumo.getObsIntegracao());
