 ...
 * @author Kelson
 */
public class FrmAddUnidadeIndustrial extends javax.swing.JInternalFrame {
    ...
    public FrmAddUnidadeIndustrial(javax.swing.JDesktopPane parent, boolean modal,UnidadeIndustrialDAO dao, FrmUnidadeIndustrial control) throws SQLException {             
        this.dao = dao;
        this.control = control;
        this.setTitle("Adicionar Unidade Industrial");
        initComponents();
        initMyComponents();
    ...
    private void btOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOkActionPerformed
        try {
            ...
            dao.addUnidadeIndustrial(unidadeIndustrial);

            int result = JOptionPane.showConfirmDialog(this, "Você Tem Certeza ??","Adicionar Unidade Industrial",JOptionPane.OK_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE);
            if(result != 0) {
                return;
            }
